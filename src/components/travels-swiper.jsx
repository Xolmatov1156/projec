...
export default function TravelsSwiper() {
  ...
  return (
    <>
      <div
        data-aos="fade-right"
        className="flex flex-col ml-[30px] relative text-white w-full max-w-[1130px] mx-auto pt-[75px]"
      >
      ...
      <Swiper
        ...
        className="mySwiper select-none text-white w-full max-w-[1232px] mx-auto mt-[40px]"
      >
