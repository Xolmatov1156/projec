    ...
    <>
      ...
      >
        <SwiperSlide className="relative">
          <div className="hero-back w-screen h-[100vh] flex justify-center items-center relative">
            <h1 className="uppercase text-white bg-black/40 rounded-lg text-[50px] text-center max-w-4xl px-4 z-10">
